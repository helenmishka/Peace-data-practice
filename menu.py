...
class MainMenu(cocos.menu.Menu):
    ...
    def __init__(self, main_game_scene):
        ...
        menus.append(cocos.menu.MenuItem(" " * 60, self.on_new_game, ))
        menus[0].y = -50

        menus.append(cocos.menu.MenuItem(" " * 60, self.on_quit))
        menus[1].y = -450
...
class Settings(cocos.menu.Menu):
    ...
    def __init__(self, set_scene):
        ...
        menus.append(cocos.menu.MenuItem(" " * 60, self.on_settings))
        menus[0].y = -320
